                ...
                <form class="form-horizontal" action="{{ route('empresa.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="regimen" class="form-control" id="regimen"
                                    placeholder="Escriba el régimen de la empresa">
                                @error('regimen')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="documento_representante" class="form-control"
                                    id="documento_representante" placeholder="Escriba el documento del representante">
