        ...
        <div class="card">
            <form class="form-horizontal" action="{{ route('empresas.store') }}"  method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="documento_representante_legal"
                            class="col-sm-3 text-end control-label col-form-label requerido">Documento Representante Legal</label>
                        <div class="col-sm-9">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a class="btn btn-dark me-md-2" href="{{route('empresas.index')}}" role="button">Volver al listado</a>
                </div>
            </form>
        </div>
@endsection
