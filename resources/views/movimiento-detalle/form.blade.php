        ...
        <div class="card">
            <div class="card-header">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a class="btn btn-danger text-white me-md-2" href="{{route('movimiento-detalle.index')}}" role="button">Cancelar</a>
                </div>
                <h4 class="card-title">Crear nuevo movimiento detalle</h4>
            </div>
            <form class="form-horizontal" action="{{ route('movimiento-detalle.store') }}"  method="POST">
                @csrf
                <div class="card-body">
