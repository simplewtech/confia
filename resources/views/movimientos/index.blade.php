...
<div class="row">
    <div class="d-md-flex justify-content-md-end">
        <a class="btn btn-dark" href="{{route('movimientos.create')}}" role="button">Nuevo Registro</a>
    </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    @foreach ($datas as $data)
                        <tr>
                            <td>{{$data->tipo_movimientos_id}}</td>
                            <td>{{$data->personas_id}}</td>
                            <td>{{$data->nombre}}</td>
                            <td>
