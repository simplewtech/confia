        ...
        <div class="card">
            <div class="card-header">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a class="btn btn-danger text-white me-md-2" href="{{route('persona.index')}}" role="button">Cancelar</a>
                </div>
                <h4 class="card-title">Crear nueva Persona</h4>
            </div>
            <form class="form-horizontal" action="{{ route('persona.store') }}"  method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control phone-inputmask" id="celular" name="celular" placeholder="Escriba su número de celular">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="email"
