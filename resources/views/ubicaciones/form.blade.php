...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" action="{{ route('ubicaciones.store') }}"  method="POST">
                @csrf
                <div class="card-body">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a class="btn btn-dark me-md-2" href="{{route('ubicaciones.index')}}" role="button">Volver al listado</a>
                </div>
            </form>
        </div>
@endsection
