...
<div class="row">
    <div class="d-md-flex justify-content-md-end">
        <a class="btn btn-dark" href="{{route('ubicaciones.create')}}" role="button">Nuevo Registro</a>
    </div>
        <div class="card-body">
                                    ...
                                    <div class="container text-center">
                                        <div class="row justify-content-md-end">
                                            <div class="co col-lg-1">
                                                <button type="submit" class="btn btn-outline btn-sm"><iconify-icon icon="mdi:edit-box" style="color: blue; font-size:2rem" ></iconify-icon></button>
                                            </div>

                                        <div class="col col-lg-1">
                                            <form action="{{ route('ubicaciones.destroy', $data->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
